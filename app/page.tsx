      ...
      <div className="bg-gradient-to-b from-indigo-200 via-white to-indigo-200">
            <div className="max-w-7xl mx-auto px-6 py-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div className="group bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                        <h2 className="text-2xl font-semibold text-indigo-600 mb-2 group-hover:text-indigo-700">
                            Users 👤
                        </h2>
                    ...
                    <div className="group bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                        <h2 className="text-2xl font-semibold text-pink-600 mb-2 group-hover:text-pink-700">
                            Posts 📮
                        </h2>
                    ...
                    <div className="group bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                        <h2 className="text-2xl font-semibold text-green-600 mb-2 group-hover:text-green-700">
                            Comments 💬
                        </h2>
                    ...
                    <div className="group bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 transition-transform">
                        <h2 className="text-2xl font-semibold text-yellow-600 mb-2 group-hover:text-yellow-700">
                            Todos 📝
                        </h2>
